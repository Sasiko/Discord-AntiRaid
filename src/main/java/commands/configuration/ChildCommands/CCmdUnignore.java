...
public class CCmdUnignore extends ChildCommand {

  public CCmdUnignore(Command parentCommand, String invoke) {
  ...
  public String description() {
    return
        "Are there certain roles that the bot should unignore?";
  }
